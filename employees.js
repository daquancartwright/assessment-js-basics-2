...
//CODE HERE
const empOne = new Employee('DaQuan', ['weekday mornings', 'weekday afternoons'])
...
//CODE HERE
const manager = new Manager('Skyler', ['weekday mornings', 'weekend nights'], ['Cece', 'Smith'])
